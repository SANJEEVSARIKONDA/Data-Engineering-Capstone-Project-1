...
LOAD DATA LOCAL INFILE '/home/anabig11425/Data_final/departments.csv' INTO TABLE my_depts FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' ignore 1 rows;
LOAD DATA LOCAL INFILE '/home/anabig11425/Data_final/dept_emp.csv' INTO TABLE my_dept_emp FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' ignore 1 rows;
LOAD DATA LOCAL INFILE '/home/anabig11425/Data_final/dept_manager.csv' INTO TABLE my_dept_mng FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' ignore 1 rows;
LOAD DATA LOCAL INFILE '/home/anabig11425/Data_final/employees.csv' INTO TABLE my_emp FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' ignore 1 rows;
LOAD DATA LOCAL INFILE '/home/anabig11425/Data_final/salaries.csv' INTO TABLE my_sal FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' ignore 1 rows;
LOAD DATA LOCAL INFILE '/home/anabig11425/Data_final/titles.csv' INTO TABLE my_emp_title FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' ignore 1 rows;
